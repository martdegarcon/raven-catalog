...
export interface Product {
  ...
  customFields?:
    | {
        ...
        type?: ('text' | 'number' | 'date' | 'textarea' | 'checkbox' | 'select' | 'link') | null;
        value_ru?: string | null;
        value_en?: string | null;
        linkUrl?: string | null;
        linkText_ru?: string | null;
        linkText_en?: string | null;
        valueCheckbox?: boolean | null;
        /**
         * Добавьте варианты (напр. 9 языков). Пользователь выберет один при заказе.
         */
        options?:
          | {
              label_ru: string;
              label_en?: string | null;
              /**
               * Для сохранения в заказе (напр. es, en)
               */
              value?: string | null;
              id?: string | null;
            }[]
...
export interface Category {
  ...
  name_en?: string | null;
  /**
   * Если это подкатегория, выбери родителя
   */
...
export interface Order {
  ...
  /**
   * Контакт пользователя (email или telegram)
   */
  contact: string;
  /**
   * Тип контакта
  ...
  /**
   * Выбранные варианты по полям типа «Выбор» (напр. язык фразы)
   */
  customSelections?:
    | {
        fieldLabel: string;
